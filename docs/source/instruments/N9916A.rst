...
Commands
""""""""
Other than featuring all the methods of :class:`qinst.instruments.network_inst.NetworkInst`, the base :class:`qinst.instruments.network.NA_N9916A.N9916A` class contains the following methods and properties common to all the operational modes of the instrument.
...
VNA mode
""""""""
Measure the scattering value parameter of a connected RF network by sweeping a probe signal over a range of frequencies. This mode is implemented by the :class:`qinst.instruments.network.NA_N9916A.VNAN9916A` class.
...
SA mode
""""""""
Measure the magnitude of an RF signal as a function of frequency. This mode is implemented by the :class:`qinst.instruments.network.NA_N9916A.SAN9916A` class.
