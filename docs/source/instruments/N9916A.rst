...
Commands
""""""""
Other than featuring all the methods of :class:`qtics.network_inst.NetworkInst`, the base :class:`qtics.instruments.network.NA_N9916A.N9916A` class contains the following methods and properties common to all the operational modes of the instrument.
